import 'package:car_rental/NotificationMoto.dart';
import 'package:car_rental/profile.dart';
...
import 'available_moto.dart';
import 'details_moto.dart';
import 'moto_widget.dart';
          ...
          BottomNavigationBarItem(
            icon: IconButton(
              ...
              onPressed: () {
                 Navigator.push(
                   context,
                   MaterialPageRoute(builder: (context) => const NotificationMoto()),
                 );
              },
            ),
